...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        <h1>UKZN Howard Clinic</h1>
        <p class="lead">Welcome To UKZN Howard Clinic To Learn how to book and or utilize this web click the button below</p>
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <p>
                <a class="btn btn-default" href="LogIn.aspx">Log In page &raquo;</a>
            </p>
        </div>
        <div class="col-md-4">
